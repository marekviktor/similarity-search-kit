...
public class SimilarityIndex: Identifiable, Hashable {
    ...
    public func search(
        ...
        let searchResults = indexMetric.findNearest(
            for: queryEmbedding, in: indexEmbeddings, resultsCount: resultCount)
...
extension SimilarityIndex {
    ...
    public func updateItem(
        id: String, text: String? = nil, embedding: [Float]? = nil, metadata: [String: String]? = nil
    ) {
